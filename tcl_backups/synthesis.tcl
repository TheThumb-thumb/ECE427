...
# # set design_toplevel aes_ctr_drbg
# #  set design_toplevel aes_cbc_mac
# set design_toplevel oht_top
# # set design_toplevel top
...
# # set modules [list \
# #    $top_dir_path/pkg/types.sv \
# #    $top_dir_path/hdl/fifo.sv \
# #    $top_dir_path/hdl/Online_Health_Test.sv
# # ]

# # set modules [list \
# #    +incdir+$top_dir_path/hdl/sbox.sv
# #    $top_dir_path/pkg
# #    $top_dir_path/hdl/sbox.sv
# #    $top_dir_path/hdl/aes_round.sv
# #    $top_dir_path/hdl/aes_round_final.sv
...
# #    $top_dir_path/sram_rf/oht_dp_sram/verilog/oht_dp_sram.v
# #    $top_dir_path/hdl/Online_Health_Test.sv
# #    $top_dir_path/hdl/ohtJ.sv
# #    $top_dir_path/hdl/oht_aes_shifter.sv
# #    $top_dir_path/hdl/fiao.sv
...
# create_clock -period 2 -name sdc_top_clk clk
...
create_clock -name sdc_top_clk -period 8 [get_pins mixed_IC/clk] 
set_clock_uncertainty 0.1 sdc_top_clk

create_generated_clock -name sdc_analog_clk -divide_by 1 -source mixed_IC/clk [get_ports analog_clk[*]]

create_generated_clock -name sdc_slow_clk -divide_by 2 -source mixed_IC/clk [get_pins mixed_IC/output_buffer_inst/slow_clk]
